...
public class GameShop implements ConfigurationSerializable {
    ...
    public GameShop(GameLocation shopPosition, GameShopType shopType, String skinName, Integer headItemName) {
    ...
    public Integer getHeadItemModel() {
        return headItem;
    }
...
//    }
    public void spawn() {
        ...
        if (getHeadItemModel() != null) {
            Integer headItemModel = getHeadItemModel();
            ItemStack helmet = new ItemStack(Material.CARVED_PUMPKIN, 1);
            helmet.editMeta(meta -> {
                meta.setCustomModelData(headItemModel);
            });
    ...
    public @NotNull Map<String, Object> serialize() {
        ...
        map.put("headModel", getHeadItemModel());
        return map;
    }
    ...
    public static GameShop deserialize(Map<String, Object> map) {
        ...
        Integer headItemModel = (Integer) map.getOrDefault("headModel", null);
        return new GameShop(shopLoc, gameShopType, skinName, headItemModel);
    }
