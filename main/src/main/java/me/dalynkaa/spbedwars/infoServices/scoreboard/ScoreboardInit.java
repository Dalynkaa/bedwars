...
public class ScoreboardInit {
    ...
    public void waitingStage() {
        sidebar.addUpdatableLine(player -> {
            ...
            if (game == null) {
                return Component.text(" Карта: ", TextColor.fromCSSHexString("#e17055")).append(Component.text("Не выбрана", TextColor.fromCSSHexString("#fab1a0")));
            }
        ...
        sidebar.addUpdatableLine(player -> {
            ...
            BWGame game = SPBedWars.getInstance().activeGames.get(bPlayer.getCurrentGame());
            if (game == null) {
                return Component.text(" Режим: ", TextColor.fromCSSHexString("#e17055")).append(Component.text("Не выбран", TextColor.fromCSSHexString("#fab1a0")));
            }
