...
public class GameSelectMenu {
    ...
    public GameSelectMenu(BPlayer bPlayer) {
        ...
        soloLore.add(Component.text("Серверов: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerList(ArenaTypes.SOLO), TextColor.fromCSSHexString("#a29bfe"))));
        soloLore.add(Component.text("Игр: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerGamesList(ArenaTypes.SOLO), TextColor.fromCSSHexString("#a29bfe"))));
        soloLore.add(Component.text("Игроков: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerPlayerList(ArenaTypes.SOLO), TextColor.fromCSSHexString("#a29bfe"))));
        ...
        duoLore.add(Component.text("Серверов: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerList(ArenaTypes.DUO), TextColor.fromCSSHexString("#a29bfe"))));
        duoLore.add(Component.text("Игр: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerGamesList(ArenaTypes.DUO), TextColor.fromCSSHexString("#a29bfe"))));
        duoLore.add(Component.text("Игроков: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerPlayerList(ArenaTypes.DUO), TextColor.fromCSSHexString("#a29bfe"))));
        ...
        trioLore.add(Component.text("Серверов: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerList(ArenaTypes.TRIO), TextColor.fromCSSHexString("#a29bfe"))));
        trioLore.add(Component.text("Игр: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerGamesList(ArenaTypes.TRIO), TextColor.fromCSSHexString("#a29bfe"))));
        trioLore.add(Component.text("Игроков: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerPlayerList(ArenaTypes.TRIO), TextColor.fromCSSHexString("#a29bfe"))));
        ...
        quadroLore.add(Component.text("Серверов: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerList(ArenaTypes.QUADRO), TextColor.fromCSSHexString("#a29bfe"))));
        quadroLore.add(Component.text("Игр: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerGamesList(ArenaTypes.QUADRO), TextColor.fromCSSHexString("#a29bfe"))));
        quadroLore.add(Component.text("Игроков: ", TextColor.fromCSSHexString("#6c5ce7")).append(Component.text(GameRegistrator.getServerPlayerList(ArenaTypes.QUADRO), TextColor.fromCSSHexString("#a29bfe"))));
