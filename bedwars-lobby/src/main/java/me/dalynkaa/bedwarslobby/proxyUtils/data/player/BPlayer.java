...
public class BPlayer {
    ...
    public void sendMessage(Component message, MessageType type){
        switch (type){
            case NORMAL -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#636e72"))).append(message.color(TextColor.fromCSSHexString("#b2bec3"))));
            case SUCCESS -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#00b894"))).append(message.color(TextColor.fromCSSHexString("#55efc4"))));
            case WARNING -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#ffeaa7"))).append(message.color(TextColor.fromCSSHexString("#fdcb6e"))));
            case ERROR -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#fab1a0"))).append(message.color(TextColor.fromCSSHexString("#e17055"))));
            case ANOTHER -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#fa8b44"))).append(message));

        }
    }
    public void sendMessage(String message, MessageType type){
        switch (type){
            case NORMAL -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#636e72"))).append(Component.text(message, TextColor.fromCSSHexString("#b2bec3"))));
            case SUCCESS -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#00b894"))).append(Component.text(message, TextColor.fromCSSHexString("#55efc4"))));
            case WARNING -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#ffeaa7"))).append(Component.text(message, TextColor.fromCSSHexString("#fdcb6e"))));
            case ERROR -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#fab1a0"))).append(Component.text(message, TextColor.fromCSSHexString("#e17055"))));
            case ANOTHER -> getPlayer().sendMessage(SPBedWarsLobby.getInstance().PREFIX.append(Component.text(" : ", TextColor.fromCSSHexString("#fa8b44"))).append(Component.text(message)));
        }
    }
    ...
    public TeamPlayer joinGame(GameRegistrator game){
        ...
        if (game.getPlayers().size()>= SPBedWarsLobby.getInstance().servers.get(game.getServerID()).getArenaType().getPlayers()){
    ...
    private void sendServer(String server) {
...
//    }
    ...
    public void connectToGame(ArenaTypes type){
        if (type == null){
        ...
        GameRegistrator game = findSuitableGame(type);
        if (game == null){
