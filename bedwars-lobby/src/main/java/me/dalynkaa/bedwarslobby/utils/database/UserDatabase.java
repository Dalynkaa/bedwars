package me.dalynkaa.bedwarslobby.utils.database;
...
public class UserDatabase {
    ...
    private SPBedWarsLobby bedWars;
    private String tableName;

    public UserDatabase(SPBedWarsLobby main, DatabaseController database, String tableName){
        this.bedWars = main;
